...
import ForgotPasswordViaPhoneScreen from '../screens/ForgotPasswordViaPhoneScreen';
...
const OnboardingNavigator = (props) => {
  return (
    ...
    >
      ...
      <Stack.Screen component={ForgotPasswordViaPhoneScreen} name="PasswordViaPhone" />
